    ...
    <section className="py-24 px-6 md:px-12 overflow-hidden bg-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <div
            className="absolute -top-10 -left-10 w-32 h-32 pattern-dots opacity-20 hidden md:block text-[var(--jiwa-red)]"
            aria-hidden="true"
          />

          <div className="relative aspect-[4/5] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-2xl group">
            <Image
              src="/janji-jiwa-overview.webp"
              alt="Janji Jiwa Brand Culture"
              fill
        ...
        >
          ...
          <p className="opacity-70 mb-12 leading-relaxed text-base md:text-lg max-w-2xl text-[var(--text-primary)] font-medium">
            Janji Jiwa bukan sekadar kedai kopi. Kami adalah jembatan yang
            menghubungkan petani lokal dengan para Teman Sejiwa melalui semangat{" "}
            <span className="text-[var(--jiwa-red)] italic">
              "Kopi Dari Hati"
            </span>
            .
          </p>
