        ...
        <main className="min-h-screen bg-[#F9F7F2] pt-40 pb-20 px-6 md:px-24">
          <div className="max-w-3xl mx-auto">
            <header className="mb-16">
              <span className="text-[10px] uppercase tracking-[0.5em] text-amber-800 font-black mb-4 block">
                Editor Mode
              </span>
              <h1 className="text-5xl md:text-6xl font-serif text-stone-900 tracking-tighter">
                Draft your <span className="italic">narrative.</span>
              </h1>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-16">
              ...
              {/* TITLE */}
              <div className="group">
                <label className="text-[10px] uppercase tracking-widest text-stone-400 font-bold block mb-4">
                  Article Title
                </label>
                <input
                  required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["Process", "Origin", "Brewing", "Lifestyle"].map(
                      (cat) => (
                        <button
                          key={cat}
                          type="button"
