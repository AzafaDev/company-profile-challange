    ...
    <main className="pt-24 min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors duration-300 pb-20">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Individu yang berdedikasi memberikan yang terbaik untuk setiap cangkir kopi Teman Sejiwa.
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto">
        ...
        >
          {loading ? (
            [...Array(6)].map((_, n) => (
              <div key={n} className="h-72 rounded-[3rem] animate-pulse bg-[var(--text-primary)]/[0.05]" />
            ))
          ) : (
            team.map((member, idx) => (
      ...
      <section className="mt-32 px-6">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-black italic mb-6">
            Ready to <span className="text-[var(--jiwa-red)]">Brew</span> with us?
          </h2>
